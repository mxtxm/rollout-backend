...
public class SiteModel {
    ...
    public static Site.Viewable getByIdAndCode(Params params) throws ServerException, NoContentException, InputException {
    ...
    public static Object search(Params params) throws ServerException, NoContentException, InputException {
        return CommonModelMongo.search(params, new Site(), new Site.Viewable());
    }
